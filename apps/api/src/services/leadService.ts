...
const VALID_LEAD_TRANSITIONS: Record<LeadStage, LeadStage[]> = {
  ...
  CONTACTED:    ["QUALIFIED", "VIEWING", "PROPOSAL", "NEGOTIATING", "CLOSED_LOST"],
  QUALIFIED:    ["VIEWING", "PROPOSAL", "NEGOTIATING", "CLOSED_LOST"],
  VIEWING:      ["PROPOSAL", "NEGOTIATING", "CLOSED_LOST"],
  PROPOSAL:     ["VIEWING", "NEGOTIATING", "CLOSED_LOST"],
