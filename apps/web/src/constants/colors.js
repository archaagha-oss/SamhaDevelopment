...
export const getStageColors = (stage) => {
    return STATUS_COLORS[stage] || { bg: "bg-slate-50", border: "border-slate-200", text: "text-slate-700", badge: "bg-slate-100 text-slate-600" };
};
