...
export default function BrokerPage() {
    ...
    const openEditForm = () => {
        ...
        setEditForm({
            ...
            bankSwiftCode: selected.bankSwiftCode ?? "",
        });
