    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-6">
        {loading ? (
          ...
          <EmptyState
            icon="◉"
            title={search ? "No offers match your search" : `No ${filter === "ALL" ? "" : filter.toLowerCase() + " "}offers`}
            description={search ? "Try clearing your search or switching the status filter." : "Create offers from a lead's profile to get started."}
          />
        ) : (
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <table className="w-full text-sm">
