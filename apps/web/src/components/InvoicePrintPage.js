...
export default function InvoicePrintPage() {
    ...
    return (_jsxs("div", { className: "bg-white min-h-screen", children: [_jsxs("div", { className: "print:hidden fixed top-4 right-4 z-50 flex gap-2", children: [_jsx("button", { onClick: () => window.print(), className: "px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 shadow-lg", children: "Download / Print" }), _jsx("button", { onClick: () => window.close(), className: "px-4 py-2 bg-slate-100 text-slate-700 text-sm font-semibold rounded-lg hover:bg-slate-200 shadow-lg", children: "Close" })] }), docVersion !== null && (_jsx("div", { className: "print:hidden fixed top-4 left-4 z-50", children: _jsxs("span", { className: "px-3 py-1.5 text-xs font-semibold bg-amber-100 text-amber-700 border border-amber-300 rounded-lg shadow", children: ["Viewing v", docVersion, " \u2014 frozen at generation time"] }) })), _jsxs("div", { className: "max-w-2xl mx-auto px-8 py-12 print:py-8 print:px-6", children: [_jsxs("div", { className: "flex items-start justify-between mb-8 pb-6 border-b-2 border-slate-800", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-slate-900 tracking-tight", children: "INVOICE" }), _jsxs("p", { className: "text-sm text-slate-500 mt-1", children: [data.projectDetails.name, " \u2014 ", data.projectDetails.location] })] }), _jsxs("div", { className: "text-right text-sm text-slate-500 space-y-1", children: [_jsxs("p", { className: "font-semibold text-slate-700", children: ["Date: ", today()] }), _jsx("p", { className: "font-mono text-xs text-slate-400", children: data.dealNumber }), _jsxs("p", { className: "text-xs font-medium text-slate-600", children: ["Due: ", fmtDate(data.dueDate)] })] })] }), _jsxs("div", { className: "mb-6", children: [_jsx("h2", { className: "text-xs font-bold text-slate-400 uppercase tracking-widest mb-3", children: "Bill To" }), _jsxs("div", { className: "bg-slate-50 rounded-xl p-4", children: [_jsx(Row, { label: "Buyer Name", value: data.buyerDetails.name, bold: true }), _jsx(Row, { label: "Phone", value: data.buyerDetails.phone }), data.buyerDetails.email && _jsx(Row, { label: "Email", value: data.buyerDetails.email })] })] }), _jsxs("div", { className: "mb-6", children: [_jsx("h2", { className: "text-xs font-bold text-slate-400 uppercase tracking-widest mb-3", children: "Property Details" }), _jsxs("div", { className: "bg-slate-50 rounded-xl p-4", children: [_jsx(Row, { label: "Unit", value: data.unitDetails.unitNumber, bold: true }), _jsx(Row, { label: "Type", value: TYPE_LABEL[data.unitDetails.type] ?? data.unitDetails.type }), _jsx(Row, { label: "Floor", value: `Floor ${data.unitDetails.floor}` }), _jsx(Row, { label: "Project", value: data.projectDetails.name })] })] }), _jsxs("div", { className: "mb-8", children: [_jsx("h2", { className: "text-xs font-bold text-slate-400 uppercase tracking-widest mb-3", children: "Invoice Details" }), _jsxs("div", { className: "bg-slate-50 rounded-xl p-4", children: [_jsx(Row, { label: "Description", value: data.milestoneLabel }), _jsx(Row, { label: "Due Date", value: fmtDate(data.dueDate) }), _jsxs("div", { className: "flex justify-between pt-3 mt-1 border-t-2 border-slate-200 text-sm", children: [_jsx("span", { className: "font-bold text-slate-700 text-base", children: "Amount Due" }), _jsx("span", { className: "font-bold text-slate-900 text-base", children: fmtAED(data.amount) })] })] })] }), _jsxs("div", { className: "bg-slate-50 border border-slate-200 rounded-xl p-4 text-sm text-slate-600 mb-8", children: [_jsx("p", { className: "font-semibold text-slate-700 mb-2", children: "Payment Instructions" }), data.paymentInstructions ? (_jsx("pre", { className: "whitespace-pre-wrap font-sans text-sm text-slate-600", children: data.paymentInstructions })) : (_jsxs(_Fragment, { children: [_jsx("p", { children: "Please transfer the amount due to our designated bank account before the due date." }), _jsx("p", { className: "mt-1 text-xs text-slate-400", children: "Quote your unit number and deal reference when making the transfer." })] }))] }), _jsxs("div", { className: "grid grid-cols-2 gap-8 pt-6 border-t border-slate-200", children: [_jsxs("div", { children: [_jsx("p", { className: "text-xs text-slate-400 uppercase tracking-wide mb-6", children: "Authorized By" }), _jsx("div", { className: "border-b border-slate-300 mb-2" }), _jsx("p", { className: "text-xs text-slate-400", children: "Developer Representative" })] }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-slate-400 uppercase tracking-wide mb-6", children: "Acknowledged By" }), _jsx("div", { className: "border-b border-slate-300 mb-2" }), _jsx("p", { className: "text-xs text-slate-400", children: data.buyerDetails.name })] })] }), _jsxs("p", { className: "text-center text-xs text-slate-300 mt-10 print:mt-6", children: ["Generated ", today(), " \u00B7 ", data.dealNumber, docVersion !== null ? ` · v${docVersion}` : ""] })] })] }));
}
